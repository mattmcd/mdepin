...
Components are set up using constructor injection.  This requires each component to inherit from mdepin.Bean and have publically settable properties for the injected services.
